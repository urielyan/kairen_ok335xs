...
void caibrateresultquery::update_page(int count){
  ...
  //result:
  QString tmp_result = p_mySettings->value(MYSETTINGS_CALIBRATE_RESULT_RESULT(count)).toString();
  ...
  //data:tablewidget
  QString tmp_data = p_mySettings->value(MYSETTINGS_CALIBRATE_RESULT_DATA(count)).toString();
